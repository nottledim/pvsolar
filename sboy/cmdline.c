...
const char *gengetopt_args_info_detailed_help[] = {
  ...
  "\nHistory:",
  "  -H, --history[=date]       Get history list for date from inverter.\n                               Default is today. Can also specify 'today' or\n                               'yesterday'.",
  ...
  "\nTime:",
  "  -t, --set-time[=seconds]   Set inverter time to current system time. Optional\n                               argument is time zone offset in seconds from\n                               GMT. West is positive, East is negative.\n                               (default=`0')",
  "\nOther options:",
...
void clear_args (struct gengetopt_args_info *args_info)
{
  ...
  args_info->set_time_arg = 0;
  args_info->set_time_orig = NULL;
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->set_time_help = gengetopt_args_info_detailed_help[18] ;
  args_info->bt_power_help = gengetopt_args_info_detailed_help[20] ;
  args_info->dc_readings_help = gengetopt_args_info_detailed_help[21] ;
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->set_time_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->set_time_given)
    write_into_file(outfile, "set-time", args_info->set_time_orig, 0);
...
cmdline_parser_required2 (struct gengetopt_args_info *args_info, const char *prog_name, const char *additional_error)
{
  ...
  if (! args_info->set_time_given)
    {
      fprintf (stderr, "%s: '--set-time' ('-t') option required%s\n", prog_name, (additional_error ? additional_error : ""));
      error_occurred = 1;
    }
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVv::qH::s:e:t::bd", long_options, &option_index);
      ...
      switch (c)
        ...
        case 'q':	/* For compatibility only. Quiet is the new default. Use verbosity (-v) as required..  */
          ...
          break;
        case 'H':	/* Get history list for date from inverter.
        ...
        Default is after dusk..  */
          ...
          break;
        case 't':	/* Set inverter time to current system time. Optional argument is time zone offset in seconds from GMT. West is positive, East is negative..  */
        
        
          if (update_arg( (void *)&(args_info->set_time_arg), 
               &(args_info->set_time_orig), &(args_info->set_time_given),
              &(local_args_info.set_time_given), optarg, 0, "0", ARG_INT,
              check_ambiguity, override, 0, 0,
              "set-time", 't',
              additional_error))
            goto failure;
